...
function renderOnlineArticleLinks(topic) {
  ...
  return `
    <div class="online-article-links">
      <strong>Articole Google News / surse în interval</strong>
      <ul>
  ...
  return `
    <article class="topic-card ${escapeAttr(coverage.status)} ${isBlocked ? 'blocked' : ''}">
      ...
      <div class="data-grid">
        ...
        <div class="data-cell"><span>Articole Google News în interval</span><strong>${getOnlineCount(topic)}</strong></div>
